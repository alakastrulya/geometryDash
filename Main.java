...
public class Main {
    public static void main(String[] args) {
        ...
        player.setName("Ақмаржан");

        Skins skin = new Skins(1, "Blue");
        player.setSkins(skin);
        ...
        System.out.println("Skin's ID: " + player.getSkins().getSkinID() + ", Color: " + player.getSkins().getColor());
        System.out.println("Achievements: ");
        for (Achieve achieve : player.getAchievements().getAchievements()) {
